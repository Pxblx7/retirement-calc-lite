...
const FALLBACK_TIPS = [
  {
    tip_es: `Considera aumentar tu aportación al PPR para maximizar tu devolución del SAT el próximo año.`,
    tip_en: "Consider increasing your PPR contribution to maximize your SAT refund next year.",
    icon: "💰",
    impact: "Alto",
  },
  {
...
4) Varía el enfoque: un tip sobre beneficios fiscales (SAT/PPR), otro sobre gastos hormiga o ahorro privado, y otro sobre la edad de retiro o inflación.
...
[
  ...
  ...
    ...
    return new Response(JSON.stringify(FALLBACK_TIPS), { 
      status: 200,
      headers: { "Content-Type": "application/json" }
    });
  }
